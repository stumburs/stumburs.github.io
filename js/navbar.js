...
document.write(
    '<a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" role="button" aria-expanded="false">Other</a>'
);
document.write('<ul class="dropdown-menu">');
document.write(
    '<li><a class="dropdown-item" href="/other/snippets">Code snippets</a></li>'
);
document.write(
    '<li><a class="dropdown-item" href="/other/links">Links</a></li>'
);
